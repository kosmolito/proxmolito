...
Write-Host "Deploy Fedora 39 Server VM" -ForegroundColor Green | Out-Host
...
$Cores = 2
$DiskSize = "32G"
$UrlLink = "https://download.fedoraproject.org/pub/fedora/linux/releases/39/Cloud/x86_64/images/Fedora-Cloud-Base-39-1.5.x86_64.qcow2"
# Get the file name from the URL
$LinkFileName = Split-Path $UrlLink -Leaf
$FileName = "fedora-39.qcow2"
...
--net0 $Net --serial0 socket --vga serial0 --scsihw virtio-scsi-pci --ide0 $StorageName":cloudinit,media=cdrom" `
--ide2 none,media=cdrom --machine q35
...
qm set $VMID --scsi0 $StorageName":vm-$VMID-disk-0,discard=on,size=$DiskSize,ssd=1"
